...
class WC_Admin_Screen_SBPS {
	...
	function wc_setting_sbp_init(){
		...
		add_settings_field(
			'wc_sbp_payment_cs',
			__( 'Convenience store', 'woo-sbp' ),
			array( $this, 'wc_sbp_payment_cs' ),
			'wc_sbp',
			'wc_sbp_payment_method',
			['label_for' => 'wc_sbp_payment_cs', 'slug' =>'wc_sbp_cs', 'class' => 'wc_sbp_payment_cs']// $arge
		);
		add_settings_field(
			'wc_sbp_payment_mb',
	...
	public function admin_enqueue_scripts( $page ) {
		...
		wp_enqueue_script( 'wc-sbp-admin-script', plugins_url( 'views/js/admin-settings.js', __FILE__ ), array( 'jquery', 'jquery-ui-core', 'jquery-ui-button', 'jquery-ui-slider' ), WC_SBP_VERSION );
