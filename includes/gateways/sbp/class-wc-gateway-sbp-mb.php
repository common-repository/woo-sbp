...
class WC_Gateway_SBP_MB extends WC_Payment_Gateway {
	...
	public function __construct() {
        ...
        // Set Carrier Company
		$this->cc_type = array();
		if(isset($this->setting_cc_dc) && $this->setting_cc_dc == 'yes') $this->cc_type = array_merge($this->cc_type, array('docomo' => __( 'docomo', 'woo-sbp' )));
		if(isset($this->setting_cc_sb) && $this->setting_cc_sb == 'yes') $this->cc_type = array_merge($this->cc_type, array('softbank2' => __( 'Softbank B', 'woo-sbp' )));
		if(isset($this->setting_cc_au) && $this->setting_cc_au == 'yes') $this->cc_type = array_merge($this->cc_type, array('auone' => __( 'Au', 'woo-sbp' )));
