 ...
 * Plugin URI: https://wordpress.org/plugins/woo-sbp/
 * Description: SoftBank Payment Gateways for WooCommerce
 * Version: 1.0.10
...
class WooSBP{
     ...
     * @var string
     */
    public $framework_version = '2.0.10';
    ...
    private function includes() {
        ...
        if(isset($wc_sbp_options['wc_sbp_cc'])){
            ...
            include_once( WC_SBP_ABSPATH.'includes/gateways/sbp/class-wc-gateway-sbp-addon-cc.php' ); // Credit Card Addon
        }
		// Convenience store
		if(isset($wc_sbp_options['wc_sbp_cs'])) require_once( WC_SBP_ABSPATH.'includes/gateways/sbp/class-wc-gateway-sbp-cs.php' );
		// Carrier Payment
		...
		include_once( WC_SBP_ABSPATH.'includes/admin/class-wc-admin-screen-sbp.php' );
...
function WooSBP_fallback_notice(){
    ...
    <div class="error">
        <ul>
            <li><?php echo __( 'Softbank for WooCommerce is enabled but not effective. It requires WooCommerce in order to work.', 'woo-sbp' );?></li>
        </ul>
    </div>
    <?php
}
